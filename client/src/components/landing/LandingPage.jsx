            ...
            <section className="py-24 md:py-36 px-4">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <p className="mt-8 text-xl text-muted-foreground max-w-3xl mx-auto">
                        Upload your spreadsheets and instantly create
                        interactive 2D and 3D charts with DataViz's powerful
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-muted-foreground">
                                Simply drag and drop your Excel files or use the
                                file browser to upload your data.
                            </p>
                        </div>
                        <div className="flex flex-col items-center">
                            <div className="flex items-center justify-center size-16 rounded-full bg-primary/10 mb-6">
                            ...
                            <p className="text-muted-foreground">
                                Select chart type, axes, and customize
                                appearance with our intuitive interface.
                            </p>
                        </div>
                        <div className="flex flex-col items-center">
                            <div className="flex items-center justify-center size-16 rounded-full bg-primary/10 mb-6">
                            ...
                            <p className="text-muted-foreground">
                                Download your visualizations, save your
                                analysis, or share insights with your team.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-16 md:py-24 bg-primary px-4">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <p className="text-xl text-primary-foreground/90 mb-10">
                        Join thousands of data analysts who have transformed
                        their Excel data into meaningful insights.
                    </p>
                    <Button
                        size="lg"
                        variant="secondary"
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <div className="text-sm text-muted-foreground">
                            &copy; {new Date().getFullYear()} DataViz. All
                            rights reserved.
                        </div>
                    </div>
                </div>
