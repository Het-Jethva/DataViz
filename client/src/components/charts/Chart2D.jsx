...
const Chart2D = () => {
    ...
    const chartData = useMemo(() => {
        if (!selectedData || !xAxis || !yAxis) {
            console.log('Chart2D: Missing required data for chart rendering', {
        ...
        console.log('Chart2D: Processing chart data with:', {
            chartType,
            xAxis,
            yAxis,
        ...
        <Card>
            ...
            <CardContent>
                ...
                <div className="mt-4 text-sm text-muted-foreground">
                    ...
                    <p>
                        <strong>Data Points:</strong> {selectedData.length}
                    </p>
                    <p>
