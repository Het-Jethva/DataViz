...
const ChartConfig = () => {
  ...
  const chartTypes = [
    { value: "line", label: "Line Chart", icon: LineChart, description: "Shows trends over time" },
    { value: "bar", label: "Bar Chart", icon: BarChart3, description: "Compares categories" },
    { value: "scatter", label: "Scatter Plot", icon: ScatterChart, description: "Shows correlation" },
    { value: "pie", label: "Pie Chart", icon: PieChart, description: "Shows proportions" },
    { value: "doughnut", label: "Doughnut Chart", icon: PieChart, description: "Shows proportions" },
    { value: "area", label: "Area Chart", icon: LineChart, description: "Shows volume over time" },
    { value: "bubble", label: "Bubble Chart", icon: Box, description: "3D scatter plot" },
  ]
    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-3">
            <Label>Y Axis</Label>
            <Select value={yAxis || ""} onValueChange={(value) => {
