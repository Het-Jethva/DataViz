            ...
            <div className="flex items-center justify-between p-4 rounded-lg border hover:shadow transition-all">
                ...
                <div className="flex items-center gap-2 ml-4">
                    ...
                    <Button
                        ...
                        aria-label={`Create chart from ${item.fileName || `Upload ${index + 1}`}`}
                    >
                    ...
                    <Popover open={open} onOpenChange={setOpen}>
                        <PopoverTrigger asChild>
                            <Button
                                variant="ghost"
                                size="icon"
                                aria-label={`Download ${item.fileName || `Upload ${index + 1}`}`}
                            >
                    ...
                    >
                        <AlertDialogTrigger asChild>
                            <Button
                                variant="ghost"
                                size="icon"
                                aria-label={`Delete ${item.fileName || `Upload ${index + 1}`}`}
                            >
