        ...
        <div className="text-center mb-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-slate-600 dark:text-slate-400 text-lg">
              Sign in to continue to DataViz
            </p>
          </div>
        </div>
          ...
          <CardContent className="space-y-6">
            <Form {...form}>
              ...
              >
                ...
                <Button
                  type="submit"
                  className="w-full h-12 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 transition-all duration-200 group"
                  disabled={isLoading}
                >
                  {isLoading ? (
