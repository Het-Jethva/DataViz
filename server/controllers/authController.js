...
export const updateProfile = async (req, res) => {
  try {
    ...
    const updatedUser = await updateProfileService({ userId, name, email, currentEmail: req.user.email })
    res.json({
      success: true,
...
export const changePassword = async (req, res) => {
  try {
    ...
    await changePasswordService({ userId: req.user._id, currentPassword, newPassword })
    res.json({
      success: true,
